...
<script type="text/javascript">
	...
	function goView(type, idx){
		...
		frm.action = "/admin/common/itm0103Pop";
			...
			<div class="contents_wrap lnb_open"><!-- 왼쪽 메뉴 접기 : class="contents_wrap lnb_close" -->
				...
				<div class="step_wrap">
					<ul class="step3">
						...
						<li class="current"><a href="/admin/common/itm0103"><span>직무면접</span></a></li>
					</ul>
				</div>
				
				<div class="contetns">	
					<form name="search_form" id="search_form" method="post" action="/admin/common/itm0103">
