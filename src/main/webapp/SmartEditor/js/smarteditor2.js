/**    * SmartEditor2 NHN_Library:SE2.3.8.O10836:SmartEditor2.0-OpenSource    * @version 10836    */    
var nSE2Version = 10836;if(typeof window.nhn=='undefined') window.nhn = {};
	...
	findReset : function() {
		...
		if(this.document.body.createTextRange){
			if(this.document.selection){
				...
				this._range.select();
			}else if(this.window.getSelection){ // [SMARTEDITORSUS-1528] IE11�� ���
...
nhn.HuskyRange = jindo.$Class({
	...
	placeStringBookmark_NonWebkit : function(){
		...
		// IE���� �� SPAN�� �յڷ� Ŀ���� �̵����� �ʾ� ������ �߻� �� �� �־�, ������ �ʴ� Ư�� ���ڸ� �ӽ÷� �־� ��.
		if(jindo.$Agent().navigator().ie){
			// SPAN�� ��ġ�� TD�� TD ���̿� ���� ���, �ؽ�Ʈ ���� �� �˼� ��� ���� �߻��Ѵ�.
			// TD�� TD���̿����� �ؽ�Ʈ ������ �ʿ� �������� �׳� try/catch�� ó��
			try{
	...
	*/
	...
	/**
	 * ����� ��Ҽ�/���� ������ Ȯ���Ѵ�
	 * ��� BTS [SMARTEDITORSUS-26]
	 * @param {Node} 	oNode	��Ҽ�/������ Ȯ���� ���
	 * @param {String}	sValue 	textDecoration ����
	...
	/**
	 * Range�� ���� ���鿡 ��Ÿ���� ����Ѵ�
	 * @param {Object} 	oStyle 					����� ��Ÿ���� ������ Object (��) �۲� �� ����� ��� { color : "#0075c8" }
	 * @param {Object} 	[oAttribute] 			����� �Ӽ��� ������ Object (��) ����� �˻��� ��� { _sm2_spchk: "������", class: "se2_check_spell" }
	 * @param {String} 	[sNewSpanMarker] 		���� �߰��� SPAN ��带 ���߿� ��� ó���ؾ��ϴ� ��� ��ŷ�� ���� ����ϴ� ���ڿ�
	 * @param {Boolean} [bIncludeLI] 			LI �� ��Ÿ�� ��뿡 ������ �������� ���� [COM-1051] _getStyleParentNodes �޼��� ����ϱ�
	 * @param {Boolean} [bCheckTextDecoration] 	��Ҽ�/���� ó���� ����� ������ ���� [SMARTEDITORSUS-26] _setTextDecoration �޼��� ����ϱ�
	 */
	...
	/**
	 * Style �� ����� ��带 �����´�
	 * @param {String}	[sNewSpanMarker]	���� �߰��ϴ� SPAN ��带 ��ŷ�� ���� ����ϴ� ���ڿ�
	 * @param {Boolean}	[bIncludeLI]		LI �� ��Ÿ�� ��뿡 ������ �������� ����
	 * @return {Array}	Style �� ����� ��� �迭
	 */
	_getStyleParentNodes : function(sNewSpanMarker, bIncludeLI){
		...
		// [COM-1051] ���������� �� �ٸ� �Է��ϰ� ��ȣ �ű� ���¿��� ����ũ�⸦ �����ϸ� ��ȣũ��� ������ �ʴ� ����
		// �θ� ��� �� LI �� �ְ�, �ش� LI �� ��� �ڽ� ��尡 ���õ� ���¶�� LI���� ��Ÿ���� ����ϵ��� ó����
		// --- Range �� LI �� ���Ե��� ���� ���, LI �� �����ϵ��� ó��
	...
	/**
	 * �����̳� ������Ʈ(elContainer)�� ��� �ڽĳ�尡 ��� �迭(waAllNodes)�� ���ϴ��� Ȯ���Ѵ�
	 * ù ��° �ڽ� ���� ������ �ڽ� ��尡 ��� �迭�� ���ϴ����� Ȯ���Ѵ�
	 * @param {Element}		elContainer	�����̳� ������Ʈ
	 * @param {jindo.$A}	waAllNodes	Node �� $A �迭
	 * @param {Node}		[oNode] ������ ���� �ɼ� ���� �����̳��� ù ��° Ȥ�� ������ �ڽ� ���� ������ indexOf �Լ� ����� ���� �� ����
	 * @return {Array}	Style �� ����� ��� �迭
	 */
...
nhn.BrowserSelection = function(win){
	...
	// [SMARTEDITORSUS-888] IE9 ���ķ� document.createRange �� ����
/*	var oAgentInfo = jindo.$Agent().navigator();
	if(oAgentInfo.ie){
...
nhn.husky.SE2M_Toolbar = jindo.$Class({
	...
	_assignHTMLElements : function(oAppContainer){
		...
		this.elTextTool = jindo.$$.getSingle("div.husky_seditor_text_tool", this.toolbarArea);	// [SMARTEDITORSUS-1124] �ؽ�Ʈ ��� ��ư�� ���� ó��
		//@ec]
	...
	$init : function(oAppContainer){
		...
		this._setRoundedCornerButton();	// [SMARTEDITORSUS-1124] �ؽ�Ʈ ��� ��ư�� ���� ó��
	},
...
*/
		...
		//�����ټ� 
		//�� �ܰ迡�� oAppContainer�� ���ǵ��� ���� ���¶� this.toolbarArea�������� ������� ���ϰ� �Ʒ��� ���� �ٽ� �����Ͽ���.
...
//		jindo.$Element(this.toolbarArea).addClass("off");
	...
	_getAffectedElements : function(el){
		...
		// ��ư Ŭ���ÿ� return false�� �� ���� ������ chrome���� ��ư�� ��Ŀ�� ������ ����.
		// ������ �ε� �ÿ� �ϰ�ó�� �� ��� �ε� �ӵ��� ���������� hover�ÿ� �ϳ��� ó��
	...
	/*
	 * �ؽ�Ʈ ����� ��ư ���� ó��
	 * [MOSS] "[UI����1��] ����Ʈ������ �ؽ�Ʈ��ٹ�ư ����ó�����̵�" ���
	 *		- ��ư ���� ó���� ���� tool_bg Ŭ���� �߰��� ���� ������Ʈ Ž���� _buttonRound Ŭ���� ��� (AU �߰�Ŭ����)
	 */
	...
	$ON_REGISTER_UI_EVENT : function(sUIName, sEvent, sCmd, aParams){
		//[SMARTEDITORSUS-966][IE8 ǥ��/IE 10] ȣȯ ��带 �����ϰ� ���� ÷�� �� ������ ������ 
		//						Ŀ�� ������ <sub><sup> �±װ� �پ ���ڰ� �ſ� �۰� �Ǵ� ����
		//���� : �Ʒ��� [SMARTEDITORSUS-901] ���� ���뿡�� ��÷�� �Ʒ�÷�� �̺�Ʈ ��� �� 
		//�ش� �÷������� ��ũ���� ������ this.htUIList�� �������� �ʾ� getsingle ���� ����÷�ο� �̺�Ʈ�� �ɷ���
		//�ذ� : this.htUIList�� �������� ������ �̺�Ʈ�� ������� ����
		...
		//[SMARTEDITORSUS-901]�÷����� �±� �ڵ� �߰� �� <li>�±׿�<button>�±� ���̿� ������ ������ �̺�Ʈ�� ��ϵ��� �ʴ� ����
		//���� : IE9, Chrome, FF, Safari ������ �±׸� ���� �� �� ������ text node�� �ν��Ͽ� firstchild�� text ��尡 �Ǿ� ��ư �̺�Ʈ�� �Ҵ���� ���� 
		//�ذ� : firstchild�� �̺�Ʈ�� �Ŵ� ���� �ƴ϶�, child �� button �� �Ϳ� �̺�Ʈ�� �ɵ��� ����
...
nhn.husky.SE2M_EditingModeChanger = jindo.$Class({
	...
	// [SMARTEDITORSUS-906][SMARTEDITORSUS-1433] Editing Mode ��� ���� ó�� (true:�����/ false:������� ����)
 ...
 * LOAD_CONTENTS_FIELD
 *
 * ������ �ʱ�ȭ �ÿ� �Ѿ�� Contents(DB ���� ��)�ʵ带 �о� �����Ϳ� �����Ѵ�.
 *
 * bDontAddUndo boolean Contents�� �����ϸ鼭 UNDO �����丮�� �߰� �����ʴ´�.
 *
---------------------------------------------------------------------------]*/
/*[
 * UPDATE_IR_FIELD
 ...
 *
 * ���� ������ �÷������� ��� ��Ų��. ��Ȱ�� ��� ��ȯ�� IR�� ����� ���ؼ� �ʱ�ȭ �ÿ� ����� �ʿ��ϴ�. 
 *
 * oEditingAreaPlugin object ���� ���� �÷����� �ν��Ͻ�
 *
---------------------------------------------------------------------------]*/
/*[
 ...
 * RESIZE_EDITING_AREA
 *
 * ���� ���� ����� ���� �Ѵ�. ���� ���Ŀ� MSG_EDITIING_AREA_RESIZE_STARTED/MSG_EDITING_AREA_RESIZE_ENED�� �߻� ���� ��� �ȴ�.
 *
 * ipNewWidth number �� ��
 * ipNewHeight number �� ����
 *
 ...
 *
 * ���� ���� ����� �ø��ų� ���δ�. ���� ���Ŀ� MSG_EDITIING_AREA_RESIZE_STARTED/MSG_EDITING_AREA_RESIZE_ENED�� �߻� ���� ��� �ȴ�.
 * ����ġ�� �Է��ϸ� �� ������� �����Ͽ� px�� ����ϸ�, width�� %�� ������ ��쿡�� �� ����ġ�� �ԷµǾ ������ �ʴ´�.
 *
 * ipWidthChange number �� ����ġ
 * ipHeightChange number ���� ����ġ
 *
---------------------------------------------------------------------------]*/
/*[
...
nhn.husky.SE_EditingAreaManager = jindo.$Class({
	...
	bIsDirty : false,
	bAutoResize : false, // [SMARTEDITORSUS-677] �������� �ڵ�Ȯ�� ��� On/Off ����
	...
	$ON_MSG_APP_READY : function(){
		...
		//[SMARTEDITORSUS-1327] IE 7/8���� ALT+0���� �˾� ���� escŬ���� �˾�â ������ �Ϸ��� �Ʒ� �κ� �� �ʿ���. 
		...
		if(!!this.fOnBeforeUnload){
			...
			window.onbeforeunload = jindo.$Fn(function(){
				// [SMARTEDITORSUS-1028][SMARTEDITORSUS-1517] QuickEditor ���� API ��������, submit ���� �߻��ϰ� �Ǵ� beforeunload �̺�Ʈ �ڵ鸵 ����
	...
	$ON_CLOSE_LAYER_POPUP : function() {
         this.oApp.exec("ENABLE_ALL_UI");                // ��� UI Ȱ��ȭ.
         this.oApp.exec("DESELECT_UI", ["helpPopup"]);       
         this.oApp.exec("HIDE_ALL_DIALOG_LAYER", []);
         this.oApp.exec("HIDE_EDITING_AREA_COVER");              // ���� ���� Ȱ��ȭ.
	...
	$AFTER_MSG_APP_READY : function(){
		...
		this.startAutoResize();	// [SMARTEDITORSUS-677] ���� �ڵ� Ȯ�� �ɼ��� TRUE�̸� �ڵ�Ȯ�� ����
	},
	
	$ON_LOAD_CONTENTS_FIELD : function(bDontAddUndo){
		var sContentsFieldValue = this.elContentsField.value;
		
		// [SMARTEDITORSUS-177] [IE9] �� ����, ���� �ÿ� elContentsField �� �� ����� ����
		// [SMARTEDITORSUS-312] [FF4] �ο뱸 ù��°,�ι�° ������ 1ȸ ���� �� �����Ϳ� ������ ����
	...
	// �������� ���� ���¸� ����� ��. �������� ���� �� �� ���� ���� �ƴ��� Ȯ�� �ؼ� ������ ���� �ƴٴ� ���â�� ���
	// RawContents ��� contents�� �̿��ص� ������, contents ȹ���� ���ؼ��� ��ȯ�⸦ �����ؾ� �Ǳ� ������ RawContents �̿�
	...
	$BEFORE_CHANGE_EDITING_MODE : function(sMode){
		...
		this.stopAutoResize();	// [SMARTEDITORSUS-677] �ش� ���� ��忡���� �ڵ�Ȯ���� ������
	...
	$AFTER_CHANGE_EDITING_MODE : function(sMode, bNoFocus){
		...
		this.startAutoResize();	// [SMARTEDITORSUS-677] ����� ���� ��忡���� �ڵ�Ȯ���� ����
	...
	$ON_FOCUS : function(){
		...
		// [SMARTEDITORSUS-599] ipad ���� �̽�.
		// ios5������ this.iframe.contentWindow focus�� �� ��� �̽�. 
		// document�� �ƴ� window�� focus() �־�߸� ������ focus�� ���� �Է��̵�.
		
		//[SMARTEDITORSUS-1017] [iOS5����] ��� ��ȯ �� textarea�� ��Ŀ���� �־ ���ڰ� �Է��� �ȵǴ� ����
		//���� : WYSIWYG��尡 �ƴ� ������ iframe�� contentWindow�� focus�� ���鼭 focus����� �۵����� ����
		//�ذ� : WYSIWYG��� �϶��� ���� �ǵ��� ���ǽ� �߰� �� ������ bluró�� �ڵ� ����
	...
	$ON_MSG_EDITING_AREA_RESIZE_STARTED : function(){
		...
		this.oApp.exec("STOP_AUTORESIZE_EDITING_AREA");	// [SMARTEDITORSUS-677] ����ڰ� ���� ����� �����ϸ� �ڵ�Ȯ�� ��� ����
...
nhn.husky.SE_EditingAreaVerticalResizer = jindo.$Class({
	...
	nEditingAreaMinHeight : null,	// [SMARTEDITORSUS-677] ���� ������ �ּ� ����
	htConversionMode : null,
	...
	$ON_MSG_APP_READY : function(){
		...
		//[SMARTEDITORSUS-941][iOS5����]�����е��� �ڵ� Ȯ�� ����� �������� ���� �� ������ â���� �� ������ �ۼ��ϸ� �����͸� �հ� ������ ���� 
		//���� : �ڵ�Ȯ�� ����� ���� �� ��� iframe�� ��ũ���� ����� �ʰ�, â�� �հ� ����
		//�ذ� : �׻� �ڵ�Ȯ�� ����� �����ֵ��� ����. �ڵ� Ȯ�� ��� ����� �̺�Ʈ �ڵ嵵 ����� ���ĸ����� ���� ó��
		if(jindo.$Agent().navigator().msafari){
			jindo.$Element(this.oResizeGrip).first().text('�Է�â ���� �ڵ� ���� ��');
		...
		if(!!this.oApp.getEditingAreaHeight){
			this.nEditingAreaMinHeight = this.oApp.getEditingAreaHeight();	// [SMARTEDITORSUS-677] ���� ������ �ּ� ���̸� ������ Gap ó�� �� ���
		}
	...
	// [SMARTEDITORSUS-906][SMARTEDITORSUS-1433] Resizbar ��� ���� ó�� (true:�����/ false:������� ����)
	...
	/**
	 * [SMARTEDITORSUS-677] [������ �ڵ�Ȯ�� ON�� ���]
	 * �Է�â ũ�� ���� ���� ��ġ�� Ȯ���Ͽ� ������ �ϴܿ� ��ġ�� ��� �ڵ�Ȯ���� ����
	 */	
	checkResizeGripPosition : function(bExpand){
		...
		if(bExpand){
			if(this.nEditingAreaMinHeight > this.oApp.getEditingAreaHeight() - nGap){	// [SMARTEDITORSUS-822] ���� ����� ��쿡 ���
...
nhn.husky.SE_EditingArea_HTMLSrc = jindo.$Class({
	...
	sMode : "HTMLSrc",
	bAutoResize : false,	// [SMARTEDITORSUS-677] �ش� �������� �ڵ�Ȯ�� ��� On/Off ����
	nMinHeight : null,		// [SMARTEDITORSUS-677] ���� ������ �ּ� ����
	...
	$ON_MSG_APP_READY : function() {
		if(!!this.oApp.getEditingAreaHeight){
			this.nMinHeight = this.oApp.getEditingAreaHeight();	// [SMARTEDITORSUS-677] ���� ������ �ּ� ���̸� ������ �ڵ� Ȯ�� ó���� �� �� ���
		}
	},
	...
	$AFTER_CHANGE_EDITING_MODE : function(sMode, bNoFocus) {
		if (sMode == this.sMode && !bNoFocus) { 
			...
			//���� : WYSIWYG��尡 �ƴ� ������ iframe�� contentWindow�� focus�� ���鼭 focus����� �۵����� ����
			//�ذ� : WYSIWYG��� �϶��� ���� �ǵ��� ���ǽ� �߰� �� ������ bluró�� �ڵ� ����
			//����� textarea������ ���� Ŭ�����ؾ߸� Ű���尡 ������ ������ �켱�� Ŀ���� �Ⱥ��̰� �ؼ� ����ڰ� ���� Ŭ���� ����.
...
nhn.husky.SE_EditingArea_TEXT = jindo.$Class({
	...
	irToText : function(sHtml) {
		...
		var aTemp = sContent.match(new RegExp(this.sRxConverter)); // applyConverter���� �߰��� sTmpStr�� ��� �������ش�.
		if (aTemp !== null) {
			sContent = sContent.replace(new RegExp(this.sRxConverter), "");
		}
		
		//0.�Ⱥ��̴� ���鿡 ���� ����. (������ ��忡 view�� text����� view�� �����ϰ� ���ֱ� ���ؼ�)		
		sContent = sContent.replace(/\r/g, '');// MS���� ���̺?�� tr���� �и����ִ� ������\r�̱� ������  text���� ����ÿ� �������� ���� \r �����ϴ� ���� �ӽ� ����. - 11.01.28 by cielo 
		sContent = sContent.replace(/[\n|\t]/g, ''); // ���๮��, �Ⱥ��̴� ��� ����
		sContent = sContent.replace(/[\v|\f]/g, ''); // ���๮��, �Ⱥ��̴� ��� ����
		//1. ����, �� ���� ó�� .
	...
	textToIr : function(sHtml) {
		...
		// applyConverter���� �߰��� sTmpStr�� ��� �������ش�. sTmpStr�� �ϳ��� string���� �ν��ϴ� ��찡 �ֱ� ����.
	...
	/**
	 * htmlSpecialChars �� �ݴ� ����� �Լ�
	 *
	 * ����) &amp, &lt, &gt, &nbsp �� ���� &, <, >, ��ĭ���� �ٲ��ش�
	 *
	 * @param {String} sText
	 * @return {String}
	 */
 ...
 * REFRESH_WYSIWYG
 *
 * (FF���) WYSIWYG ��带 ��Ȱ��ȭ �� �ٽ� Ȱ��ȭ ��Ų��. FF���� WYSIWYG ��尡 �Ϻ� ��Ȱ��ȭ �Ǵ� ������
 * ����] REFRESH_WYSIWYG�Ŀ��� ������ selection�� ������ Ŀ�� ���� ������ ���� ������ ����. (stringbookmark�� ó���ؾ���.)
 *  
 * none
 *
---------------------------------------------------------------------------]*/
...
//	iMinUndoInterval : 50,
	...
	$init : function(iframe){
		...
		// IE���� ������ �ʱ�ȭ �ÿ� ���������� iframe�� ��Ŀ���� ����(IME �Է� �ȵǰ� Ŀ���� �����̴� ����) �ִ� ������ ���� ���ؼ� �ϴ� iframe�� ��� �״ٰ� CHANGE_EDITING_MODE���� ������ ��ȯ �� �����ش�.
		// �̷� ������ �پ��� ��ҿ� ���ؼ� �߻��ϸ� �߰ߵ� ��� ����,
		// - frameset���� �������� ������ �Ŀ� �Ѱ��� frame�ȿ� ��ư�� �ξ� �����ͷ� ��ũ �� ���
		// - iframe�� ���� �������� �����ϴ� text field�� ���� �Ҵ� �� ���
		if(oAgent.ie){
			this.iframe.style.display = "none";
		}
	
		// IE8 : ã��/�ٲٱ⿡�� ���� �Ϻο� ��Ÿ���� ���� ��� ã�Ⱑ �ȵǴ� ������ ���׷� ���� EmulateIE7 ������ ���
		...
		this.aAddtionalEmulateIE7.push(8); // IE8�� Default ���
	...
	$ON_MSG_APP_READY : function(){
		...
		// DTD�� quirks�� �ƴ� ��� body ���� 100%�� ����� �������� �ʾƼ� Ÿ�Ӿƿ��� ���� ���̸� �������� ��� �Ҵ� �� �� 
		// body ���̰� ����� ���� ���� ���� ���, ���⿡�� �̻��� ���̳� ���콺�� �ؽ�Ʈ ������ �� �ȵȴٵ��� �ϴ� �̽��� ����
	...
	/**
	 * [SMARTEDITORSUS-677] �ٿ��ֱ⳪ ���� �Է¿� ���� ���� �ڵ� Ȯ�� ó��
	 */ 
	...
	/**
	 * [SMARTEDITORSUS-677] WYSIWYG ���� ���� �ڵ� Ȯ�� ó�� ����
	 */ 
	startAutoResize : function(){
		...
		// [SMARTEDITORSUS-887] [��α� 1��] �ڵ�Ȯ�� ��忡�� ������ ���λ������ ū ������ �߰����� �� ���ν�ũ���� �Ȼ��� ����
		if(oBrowser.ie && oBrowser.version < 9){
			jindo.$Element(this.getDocument().body).css({ "overflow" : "visible" });

			// { "overflowX" : "visible", "overflowY" : "hidden" } ���� �����ϸ� ���� ��ũ�� �� �ƴ϶� ���� ��ũ�ѵ� ������ �ʴ� ������ �־�
			// { "overflow" : "visible" } �� ó���ϰ� �������� container ����� �÷� ���� ��ũ���� ������ �ʵ��� ó���ؾ� ��
			// [�Ѱ�] �ڵ� Ȯ�� ��忡�� ������ �þ �� ���� ��ũ���� �����ٰ� ������� ����
		}else{
	...
	/**
	 * [SMARTEDITORSUS-677] �ڵ� Ȯ�� ó������ ����� Resize Body Height�� ����
	 */ 
	...
	_setAutoResize : function(){		
		...
		if((oBrowser.ie && oBrowser.nativeVersion >= 9) || oBrowser.chrome){	// ������ �پ scrollHeight�� �پ���� ����
		...
		// }else if(oBrowser.safari){	// -- ���ĸ����� ������ �پ���� �ʴ� ������ �־� Firefox ������� ������
			// // [Chrome/Safari] ũ���̳� ���ĸ������� Body�� iframe���̼� ���� ����Ǿ� �þ�Ƿ�,
			// // nContainerHeight�� �߰��� ���ϴ� ��� setTimeout �� ���� ���ĵǴ� ������ �߻��� �� ����
			...
			// [FF] nContainerHeight�� �߰��� ���Ͽ���. setTimeout �� ���� ���ĵǴ� ������ �߻��� �� ����
			if(nBodyHeight > this.nBodyMinHeight){
				oCurrentStyle = this.oApp.getCurrentStyle();
				nStyleSize = parseInt(oCurrentStyle.fontSize, 10) * oCurrentStyle.lineHeight;
		...
		this.iframe.style.height = nContainerHeight + "px";				// ���� IFRAME�� ���� ����
		this.oApp.welEditingAreaContainer.height(nContainerHeight);		// ���� IFRAME�� ���δ� DIV ���� ����
	...
	_setBodyHeight : function(){
		if( this.bStopCheckingBodyHeight ){ // ����� �ϴ� ��� true, ��� üũ�ؾ� �ϸ� false
			// ������ ��忡�� �ٸ� ���� ������ �� "document�� css�� ��� �Ҽ� ����ϴ�." ��� error �� �߻�.
			// �׷��� on_change_mode���� bStopCheckingBodyHeight �� true�� ���������� ��.
			return;
		}
		...
		if(nBodyHeight === 0){	// [SMARTEDITORSUS-144] height �� 0 �̰� ������ ������ ũ��10 ���� ĳ���� ������ ����
		...
		welBody.css("height", "0px");
		// [SMARTEDITORSUS-257] IE9, ũ�ҿ��� ������ �����ص� ��ũ���� �����ִ� ���� ó��
		// body �� ������ ������� scrollHeight �� �پ���� �ʾ� height �� ������ 0 ���� ����
		...
		// nMarginTopBottom �� ���� ������ ��ũ���� ��� �þ�� ��찡 ���� (��� [BLOGSUS-17421])
	...
	$ON_IE_CHECK_EXCEPTION_FOR_SELECTION_PRESERVATION : function(){
		// ���� ���õ� �ٸ���Ʈ�� iframe�̶��, �������� ��� ��� �� ���� �ʾƵ� ���� ������ RESTORE_IE_SELECTION�� Ÿ�� �ʵ��� this._oIERange�� �����ش�.
		// (�ʿ� ���� �Ӵ��� ���� �� ���� �߻�)
		...
		/* // [SMARTEDITORSUS-978] HuskyRange.js �� [SMARTEDITORSUS-888] �̽� ������ ���
	...
	$ON_CHANGE_EDITING_MODE : function(sMode, bNoFocus){
		if(sMode === this.sMode){
			// [SMARTEDITORSUS-1213][IE9, 10] ���� ���� �� zindex 1000�� div�� �����ϴµ�, �� ���� ����� drag�� �õ��ϴ� ���� drop�� �Ұ���.
	...
	$ON_IE_HIDE_CURSOR : function(){
		...
		// [SMARTEDITORSUS-978] IE9���� removeAllRanges�� ���ŵ��� �ʾ�
		// ���� IE�� �����ϰ� empty ����� ����ϵ��� �Ͽ����� doc.selection.type�� None�� ��� ����
		// Range�� �缳�� ���־� selectNone ���� ó���ǵ��� ����ó��
		...
		if(this.oApp.oNavigator.ie){
			...
			switch(oKeyInfo.keyCode){
				...
				case 34:
					...
					break;
				case 8:		// [SMARTEDITORSUS-495][SMARTEDITORSUS-548] IE���� ǥ�� �������� �ʴ� ����
					this._backspaceTable(oEvent);
					break;
				default:
			}
		}else if(this.oApp.oNavigator.firefox){
			// [SMARTEDITORSUS-151] FF ���� ǥ�� �������� �ʴ� ����
			if(oKeyInfo.keyCode === 8){				// backspace
				this._backspaceTable(oEvent);
			}
		}
		
		this._recordUndo(oKeyInfo);	// ù��° Delete Ű �Է� ���� ���°� ����ǵ��� KEYDOWN ������ ����
	},
	...
	$ON_PASTE_HTML : function(sHTML, oPSelection, bNoUndo){
		...
		//[SMARTEDITORSUS-888] ������ �� �׽�Ʈ �� �Ʒ� �κ��� ���ʿ��Ͽ� ������
		//	- [SMARTEDITORSUS-387] IE9 ǥ�ظ�忡�� ������Ʈ �ڿ� ��� ������Ʈ�� ��� ���¿��� Ŀ���� �ȵ��� ����.
		...
		if(!oNavigator.ie){
			...
			// [SMARTEDITORSUS-56] ������ �������� ÷���� ��� ���̾� ���Ե��� �ʴ� �������� �̽��� �߰��ϰ� �Ǿ���ϴ�.
			// �׷��� �̴� ��� '�ټ��� ������ ÷���� ���'���� �߻��ϴ� ������ �ƴϾ��, 
			// ���� Ȯ�� ��� ������ ���� �� ���� Bookmark ���� �� ���ŵ� Selection �� ����� �ݿ����� �ʴ� ���� �־���ϴ�.
			// �̿�, Selection �� �����ϴ� �ڵ带 �߰��Ͽ����ϴ�.
			oSelection = this.oApp.getSelection();
			
			//[SMARTEDITORSUS-831] ��IE �迭 ������ ��ũ�ѹٰ� ���� �����Է� �� ���� Ŭ������ ���� ���¿��� 
			//�̹��� �ϳ� ���� �� �̹����� ��Ŀ���� ������ �ʽ��ϴ�.
			//���� : parameter�� �Ѱ� ���� oPSelecion�� ����� ���� ������ ���� �ʾƼ� �߻�
			//�ذ� : parameter�� �Ѱ� ���� oPSelecion�� ����� ���� �������ش�
			//       call by reference�� �Ѱ� �޾����Ƿ� ���� ��ü ���� ���� ���� �ٲ��ִ� setRange �Լ� ���
			if(!!oPSelection){
				oPSelection.setRange(oSelection);
			}
		}else{
			// [SMARTEDITORSUS-428] [IE9.0] IE9���� ����Ʈ ���⿡ �����Ͽ� ������ ������ �۰� ÷�� �� ���͸� Ŭ�� �� �۰��� �����
			// PASTE_HTML �Ŀ� IFRAME �κ��� ���õ� ���¿��� Enter �� ������ ���ŵǾ� �߻��� ����
			oSelection.collapseToEnd();
			oSelection.select();
	...
	$ON_FOCUS_N_CURSOR : function (bEndCursor, sId){
		...
		oSelection = this.oApp.getSelection();
		if(!oSelection.collapsed){ // select ������ �ִ� ���
			if(bEndCursor){
				oSelection.collapseToEnd();
			} else {
				oSelection.collapseToStart();
			...
			oSelection.select();
		}else if(bEndCursor){ // select ������ ��� ���¿��� bEndCursor �̸� body �� �ڷ� �̵���Ų��.
			this.oApp.exec("FOCUS");
	...
	/* 
	 * ������Ʈ�� WYSIWYG Window�� Visible �κп��� ������ ���̴� �������� Ȯ�� (�Ϻθ� ���̸� false)
	 */
	...
	/* 
	 * [SMARTEDITORSUS-824] [SMARTEDITORSUS-828] �ڵ� ��ũ�� ó��
	 */
	...
	$BEFORE_MSG_EDITING_AREA_RESIZE_STARTED  : function(){
		// FF���� Height���� �ÿ� ������ _fitElementInEditingArea()�Լ� �κп��� selection�� ������ ������ ��� ���ؼ�
		// StringBookmark�� ����ؼ� ��ġ�� �����ص�. (step1)
		if(!jindo.$Agent().navigator().ie){
			var oSelection = null;
			oSelection = this.oApp.getSelection();
	...
	$AFTER_MSG_EDITING_AREA_RESIZE_ENDED : function(FnMouseDown, FnMouseMove, FnMouseUp){
		...
		// $BEFORE_MSG_EDITING_AREA_RESIZE_STARTED���� ������ StringBookmark�� �������ְ� ������.(step2)
		if(!jindo.$Agent().navigator().ie){
	...
	/**
	  * EVENT_EDITING_AREA_PASTE �� ON �޽��� �ڵ鷯
	  *		������ ��忡�� ������ ������ paste �̺�Ʈ�� ���� �޽����� ó���Ѵ�.
	  *		paste �ÿ� ������ �ٿ��� ������ ������ �ٷ� ������ �� ��� delay �� �ش�.
	  */	
	...
	// [SMARTEDITORSUS-855] IE���� Ư�� ��α� ���� �����Ͽ� �ٿ��ֱ� ���� �� ������ ���ŵǴ� ����
	_replaceBlankToNbsp : function(el){
		...
		if(oNavigator.nativeVersion !== 9 || document.documentMode !== 7) { // IE9 ȣȯ��忡���� �߻�
			return;
		}
	...
	setIR : function(sIR){
		// [SMARTEDITORSUS-875] HTML ����� beautify���� �߰��� ����� �ٽ� ����
		//sIR = sIR.replace(/(>)([\n\r\t\s]*)([^<]?)/g, "$1$3").replace(/([\n\r\t\s]*)(<)/g, "$2")
		// --[SMARTEDITORSUS-875]
		...
		// [SMARTEDITORSUS-1279] [IE9/10] pre �±� �Ʒ��� \n�� ���ԵǸ� ������ ���� �ʴ� �̽�
		/*if(oNavigator.ie && oNavigator.nativeVersion >= 9 && document.documentMode >= 9){
			// [SMARTEDITORSUS-704] \r\n�� �ִ� ��� IE9 ǥ�ظ�忡�� ���� �� ������ <p>�� �߰��ϴ� ����
			sContent = sContent.replace(/[\r\n]/g,"");
		}*/
...
//}
/**
 * @pluginDesc EnterŰ �Է½ÿ� ���� ���� P �±׷� ���ų� <br> �±׸� �����Ѵ�.
 */
nhn.husky.SE_WYSIWYGEnterKey = jindo.$Class({
	...
	$init : function(sLineBreaker){
		...
		// [SMARTEDITORSUS-227] IE �� ��쿡�� ������ Enter ó�� ������ ����ϵ��� ����
		if(this.htBrowser.opera && this.sLineBreaker == "P"){
			this.$ON_MSG_APP_READY = function(){};
		}

		/**
		 *	[SMARTEDITORSUS-230] ����+���󺯰� ��, ����ġ�� ��ũ��Ʈ ����
		 *	[SMARTEDITORSUS-180] [IE9] ���� ��� ��, ����Ű 2ȸ�̻� �Է½� Ŀ����ġ�� ���� �������� �̵����� ����
		 * 		���� ���� : 	IE9 ���� ���� �� ��� P �±װ� "�� SPAN �±׸� ������ ���" P �±� ������ ������ �ʰų� ��Ŀ���� ���� �ö� ����
		 *		�ذ� ��� : 	Ŀ�� Ȧ���� IE �̿ܿ����� <br> �� ���
		 *						- IE ������ ������ �� <br> �κп��� ���������� P �±װ� ��Ǿ� [SMARTEDITORSUS-230] ���� �߻�
		 *						unescape("%uFEFF") (BOM) �� �߰�
		 *						- IE9 ǥ�ظ�忡�� [SMARTEDITORSUS-180] �� ������ �߻���
		 *						(unescape("%u2028") (Line separator) �� ����ϸ� P �� �������� ���̵�����Ʈ�� ����Ǿ� ������� ����)
		 *	IE ������ Enter ó�� ��, &nbsp; �� �־��ֹǷ� �ش� ����� �״�� ����ϵ��� ������
		 */
	...
	$ON_MSG_APP_READY : function(){
		...
		this.tmpTextNode = this.oSelection._document.createTextNode(unescape("%u00A0"));	// ���(&nbsp;) �߰� �� ����� ���
	...
	/**
	 * [SMARTEDITORSUS-950] ������ ��� �������� Compatible meta IE=edge ���� �� �ٰ��� ����� �̽� (<BR>)
	 */
	$ON_REGISTER_CONVERTERS : function(){
	...
	/**
	 * IR_TO_DB ��ȯ�� ó��
	 *	Chrome, FireFox�� ��쿡�� �Ʒ��� ���� ó���� �մϴ�. 
	 *	: ���� �� ���� �������� P �Ʒ��� ��� ���� �±� �� ���� ������ childNode�� BR�� ��츦 Ž���Ͽ� �̸� &nbsp;�� ������ �ݴϴ�.
	 */
	...
	// [IE] Selection ���� ��带 ������ �� ��忡 unescape("%uFEFF") (BOM) �� �߰�
	...
	_wrapBlock : function(oEvent, sWrapperTagName){
		...
		if(!oStart.bParentBreak || oSelection.rxBlockContainer.test(oStart.oLineBreaker.tagName)){
			...
			if(!!oStart.oNode.parentNode && oStart.oNode.parentNode.nodeType !== 11){
				...
				oSelection.moveToStringBookmark(sBM, true);	// [SMARTEDITORSUS-180] ��Ŀ�� ����
				oSelection.collapseToEnd();					// [SMARTEDITORSUS-180] ��Ŀ�� ����
		...
		if(this.htBrowser.firefox){
			...
			// [SMARTEDITORSUS-26] Enter �Ŀ� ����/��Ҽ��� ������� �ʴ� ������ ó�� (������ Enter ó�� �� ����ǵ��� setTimeout ���)
			...
			// [SMARTEDITORSUS-180] �� SPAN �±׿� ���� ���� �� ���Ͱ� ���� ���� ������ ���̴� ���� (������ Enter ó�� �� ����ǵ��� setTimeout ���)
	...
	// [IE9 standard mode] ���� ���� ��/�ϴ� P �±׸� Ȯ���Ͽ� BOM, ���(&nbsp;) �߰�
	_addExtraCursorHolder : function(elUpperNode){
		...
		if(!!elUpperNode && elUpperNode.tagName === "SPAN"){ // SPAN �� ��쿡�� �߻���
			oNodeChild = elUpperNode.lastChild;
									
			while(!!oNodeChild){	// �� Text ����
		...
		this._addSpace(elParent.previousSibling);	// ��� P ��忡 ��鹮�� �߰�
		this._addSpace(elParent);					// �ϴ� P ��忡 ��鹮�� �߰�
	...
	_addSpace : function(elNode){
		...
		return elNode;	// [SMARTEDITORSUS-418] return ������Ʈ �߰�
	},
	...
	_addTextDecorationTag : function(bAddUnderline, bAddLineThrough){
		...
		oSelection.collapseToEnd(); // End �� �ؾ� ���� ��� ��� ������ Selection �� ��
		oSelection.select();
	},
	
	// [IE9 standard mode] _getStyleOnlyNode ���� ��带 �˻��� �� �� ��尡 ������ BOM �߰� 
	...
	_getStyleOnlyNode : function(elNode){
		...
		// [SMARTEDITORSUS-227] TEXT_NODE �� return �Ǵ� ������ ������. IE ���� TEXT_NODE �� innrHTML �� �����ϸ� ���� �߻�
	...
	_insertBR : function(oEvent){
		...
		if(!this.htBrowser.ie){
			...
			// <div> 1234<br></div>�ΰ��, FF������ ���� �������� Ŀ�� �̵��� �� �Ͼ.
			// �׷���  <div> 1234<br><br type='_moz'/></div> �̿� ���� �����־�� ������ �� 2�ٷ� �Ǿ� ����.
 ...
 */
 nhn.ColorPicker = jindo.$Class({
	...
	_paintHueWithFilter : function() {
		...
		w -= nPanelBorderWidth * 2; // borderWidth�� ������ ���� ���� ����  
...
nhn.husky.SE2M_Accessibility = jindo.$Class({
	...
	$ON_MSG_APP_READY : function(){
        ...
        if ((this.sType == 'basic' || this.sType == 'light') && (this.sLang != 'ko_KR'))  {
                ...
                //[SMARTEDITORSUS-1327] IE 7/8���� ALT+0���� �˾� ���� escŬ���� �˾�â ������ �Ϸ��� �Ʒ� �κ� �� �ʿ���. (target�� document�� �Ǿ�� ��!)
	...
	$LOCAL_BEFORE_FIRST : function(sMsg){
        ...
        //[css markup] left:11 top:74�� �Ǿ� ����
	},

	
	//SE2M_Configuration_General ���� ������ ������ ���� ������ ������Ʈ�� ��Ŀ���� �̵��ϵ��� �Ѵ�. 
	...
	$ON_FOCUS_TOOLBAR_AREA : function(){
		...
		//IE7������ ALT+F10 �������� �� ��Ŀ���� ������ �������� ���� ������ ���Ƿ� ������ ���� üũ�ؼ� window.focus �־���.   
		if(jindo.$Agent().navigator().ie && jindo.$Agent().navigator().version == 7) {
            window.focus();
		}
	...
	$ON_OPEN_HELP_POPUP : function() {
        ...
        //[SMARTEDITORSUS-1327] IE���� ��Ŀ�� �̽��� IE�� ���ؼ��� window.focus������. 
        if(jindo.$Agent().navigator().ie) {
        	window.focus();
        }
 ...
 */
 nhn.husky.SE2M_ColorPalette = jindo.$Class({
	...
	$ON_APPLY_COLOR : function(elButton){
		...
		if(welColorParent.hasClass("husky_se2m_color_palette")){				// ���ø� ���� ���
		...
		}else if(welColorParent.hasClass("husky_se2m_color_palette_recent")){	// �ֱ� ���� ���
			this.oApp.exec("COLOR_PALETTE_APPLY_COLOR", [sColorCode,true]);
		}
	},
...
//		this.oApp.exec("REGISTER_UI_EVENT", ["styleRemover", "click", "EXECCOMMAND", ["RemoveFormat", false, false]]);
	...
	/**
	 * TBODY, TR, TD ���̿� �ִ� �ؽ�Ʈ������� �Ǻ��Ѵ�.
	 * @param oNode {Node} �˻��� ���
	 * @return {Boolean} TBODY, TR, TD ���̿� �ִ� �ؽ�Ʈ������� ����
	 */
	_isTextBetweenTable : function(oNode){
		var oTmpNode;
		if(oNode && oNode.nodeType === 3){	// �ؽ�Ʈ ���
	...
	$BEFORE_EXECCOMMAND : function(sCommand, bUserInterface, vValue, htOptions){
		...
		//������ ���� Ŭ���� �ѹ� �� �Ͼ ���¿��� ũ�Ұ� IE���� EXECCOMMAND�� ���������� �� ������ ����. 
		this.oApp.exec("FOCUS");
		this._bOnlyCursorChanged = false;
		oSelection = this.oApp.getSelection();
		// [SMARTEDITORSUS-1584] IE���� ���̺��� �±� ������ �ؽ�Ʈ��尡 ���Ե� ä�� execCommand �� ����Ǹ� 
		// ���̺� �±׵� ���̿� ���� P �±װ� �߰��ȴ�. 
		// ���̺��� �±� ���̿� �±װ� ������ ���� ��߳��� ������ getContents �� �� ���� P �±׵��� ������ ���������� �ȴ�.
		// ������ execCommand ����Ǳ� �� �����ǿ� ���̺��� �±� ������ �ؽ�Ʈ��带 ã�Ƴ� �����ش�.
		for(var i = 0, aNodes = oSelection.getNodes(), oNode;oNode = aNodes[i]; i++){
			if(this._isTextBetweenTable(oNode)){
				// TODO: ��带 �������� �ʰ� Selection ������ ���� �ִ� ����� ������?
		...
		if(sCommand.match(/^bold|underline|italic|strikethrough|superscript|subscript$/i)){
			...
			if( nhn.CurrentSelection.isCollapsed()){
				...
				//[SMARTEDITORSUS-228] �۲� ȿ�� �̸� ���� �� �Ŀ� �ؽ�Ʈ �Է� ��, ���� ������ ���ǳ� ���� ����� ���� ��Ҽ� ���� ȿ��� ���ȵ�
				if( this.oNavigator.ie ){
	...
	$ON_EXECCOMMAND : function(sCommand, bUserInterface, vValue){
		...
		if( bSelectedBlock){
			...
			case "outdent":
				...
				oSelection.select();
				oSelection.removeStringBookmark(sBookmark); //bookmark ����
			...
			default:
				// [SMARTEDITORSUS-1143] IE9, IE10�� �����ϴ� '�� �ؽ�Ʈ ���'���� ��Ʈ ��Ÿ���� ���Ǹ� ���̾ƿ��� ������ ������ �߻� 
				// jindo.$Element#child �� �� �ؽ�Ʈ ��带 �������� �ʱ� ������ HuskyRange �޼���� ó��
...
//					var oIESelection = this.oEditingArea.selection.createRange();
					...
					if(oSelection == ""){
						...
						if(aNode.length > 0){
							for(index in aNode){
								...
								// selection �� ���Ե� '�� �ؽ�Ʈ ���' ���� ���Ǿ� ���� ��Ʈ ��Ÿ���� �����Ѵ�.
								if((whiteSpaceStartPattern.test(elChildNode.nodeValue)) && (!nonEmptyTextPattern.test(elChildNode.nodeValue)) && (elChildNode.nodeType == 3)){ // �� �ؽ�Ʈ ���
									var elChildNodeClone = elChildNode.cloneNode();
									
									// ��Ʈ ��Ÿ���� ���Ǹ�, �ش� ��Ÿ�� �±װ� '�� �ؽ�Ʈ ���'�� �θ�μ� ���ΰ� �ִ�.
				...
				//}
				// [SMARTEDITORSUS-1143] IE9, IE10�� �����ϴ� '�� �ؽ�Ʈ ���' ��� �̽��� �б�ó�� 
				//this.oEditingArea.execCommand(sCommand, bUserInterface, vValue);
				// --[SMARTEDITORSUS-1143]
			}
		}
	...
	// [SMARTEDITORSUS-851] align, text-align�� fix�ؾ� �� ��� ��带 ã��
	...
	_fixAlign : function(sAlign){
		...
		if(oSelection.collapsed){
			aNodes[0] = oSelection.startContainer;	// collapsed�� ��쿡�� getNodes�� ���� []
		}else{
			aNodes = oSelection.getNodes();
		}
		...
		for(var i=0, nLen=aNodes.length; i<nLen; i++){
			...
			if(elParentNode && elParentNode.align !== elParentNode.style.textAlign){ // [SMARTEDITORSUS-704] align �Ӽ��� text-align �Ӽ��� ���� ������
	...
	_getDocumentBR : function(){
		...
		// [COM-715] <Chrome/Safari> ���� ���� > ������ �������� ��ȣ�ű��, ��ȣ�ű�� �����Ҷ����� ���� �ڽ��� �Ʒ��� �̵���
		// ExecCommand�� ó���ϱ� �� ������ BR�� ����
	...
	_fixDocumentBR : function(){
		// [COM-715] ExecCommand�� ó���� �Ŀ� ������Ʈ�� BR�� ó�� �� ������ BR�� ���Ͽ� ��� BR�� ����
	...
	_outdentMargin : function(elDiv){
		...
		if(elDiv.tagName === "LI"){
			...
			if(elDiv.previousSibling && elDiv.previousSibling.tagName && elDiv.previousSibling.tagName.match(/LI|UL|OL/)){
				// ���Ʒ��� sibling li/ol/ul�� �ִٸ� ol/ul�� 2���� ������ߵ�
	...
	// [SMARTEDITORSUS-793] Chrome ���� ������ �̽� �߻�, Chrome �� �� P �±׷δ� ó������ ���� &nbsp; �߰�
	...
	// 
	// [IE] �ο뱸 �ȿ��� �۸Ӹ� ��ȣ�� ������� ��, �ο뱸 �ۿ� ���� ��ȣ�ű��/�۸Ӹ� ��ȣ�� �ο뱸 ������ ���� ���� ���� ó��
	...
	_extendBlock : function(){
		// [SMARTEDITORSUS-663] [FF] block������ Ȯ���Ͽ� Range�� ���� �������ִ°��� �� �����̹Ƿ�
		// �ذ��� ���ؼ��� ���� ���õ� �κ��� Block���� extend�Ͽ� execCommand API�� ó���� �� �ֵ��� ��
		...
		// <p><img><br/><img><br/><img></p> �� �� �̹����� �Ϻθ� ���õǸ� �߻�
		// - container ���� P �̰� container ����� �ڽĳ�� �� �̹����� �������ε� ���õ� �̹����� �� �� �Ϻ��� ���
...
nhn.husky.SE2M_FontColor = jindo.$Class({
	...
	$ON_APPLY_FONTCOLOR : function(sFontColor){
		...
		// [SMARTEDITORSUS-907] ��� ������ SET_WYSIWYG_STYLE�� ������ �����ϵ��� ����
		// var oAgent = jindo.$Agent().navigator();
		// if( oAgent.ie || oAgent.firefox ){	// [SMARTEDITORSUS-658] Firefox �߰�
		//	this.oApp.exec("SET_WYSIWYG_STYLE", [{"color":sFontColor}]);
		// } else {
...
nhn.husky.SE2M_FontNameWithLayerUI = jindo.$Class({
	...
	addAllFonts : function(){
		...
		// family name -> display name ���� (����Ʈ�� �ΰ��� �ٸ�)
		...
		if(!this.htOptions || !this.htOptions.aDefaultFontList || this.htOptions.aDefaultFontList.length === 0){
			...
			this.addFont("����ü,DotumChe,AppleGothic", "����ü", 0, "", "", 1);
			this.addFont("����,Gulim", "����", 0, "", "", 1, null, true);
			this.addFont("����ü,GulimChe", "����ü", 0, "", "", 1, null, true);
			this.addFont("����,Batang,AppleMyungjo", "����", 0, "", "", 1);
			this.addFont("����ü,BatangChe", "����ü", 0, "", "", 1, null, true);
			this.addFont("�ü�,Gungsuh,GungSeo", "�ü�", 0, "", "", 1);
	...
	_attachIEEvent : function(){
		...
		if(this.htBrowser.nativeVersion < 9){		// [SMARTEDITORSUS-187] [< IE9] ���� paste ������ ����Ʈ ������ �ε�
		...
		if(document.documentMode < 9){	// [SMARTEDITORSUS-169] [>= IE9] ���� ��Ŀ�� ������ ����Ʈ �ε�
	...
	_onMouseupCover : function(e){
		...
		// [SMARTEDITORSUS-363] ������ Selection �� �ֵ��� ó����
	...
	_addFontToMenu: function(sDisplayName, sFontFamily, sSampleText){
		...
		if(this.aLIFontNames.length > 20){
			...
			this.oDropdownLayer.style.width = '204px';	// [SMARTEDITORSUS-155] ��ũ���� �����Ͽ� 206px �� �ǵ��� ó��
		}
	},
	...
	$ON_EVENT_FONTNAME_LAYER_CLICKED : function(wev){
		...
		// [SMARTEDITORSUS-169] ����Ʈ�� ��� fontFamily �� ' �� �ٿ��ִ� ó���� ��
	...
	$ON_SET_FONTFAMILY : function(sFontFamily, sDefaultSize){
		...
		// fontFamily�� fontSize �ΰ��� �׼��� �ϳ��� ��� undo history ����
	...
	_getFontFamilyFromLI : function(elLi){
		...
		// <li><button type="button"><span>����</span>(</span><em style="font-family:'����',Dotum,'����',Gulim,Helvetica,Sans-serif;">����</em><span>)</span></span></button></li>
...
*/		
		// [SMARTEDITORSUS-169] [IE9] ����ƮA ����>����ƮB ����>����Ʈ A�� �ٽ� �����ϸ� ����Ʈ A�� ������ �ʴ� ������ �߻�
		//
		// [����]
		// 		- IE9�� ����Ʈ �ε�/��ε� ����
		// 			����Ʈ �ε� ����: StyleSheet �� @font-face ������ �ؼ��� ����, DOM Tree �󿡼� �ش� ����Ʈ�� ���ʷ� ���� ����
		// 			����Ʈ ��ε� ����: StyleSheet �� @font-face ������ �ؼ��� ����, DOM Tree �󿡼� �ش� ����Ʈ�� ���̻� ������ �ʴ� ����
		// 		- �޴� ����Ʈ�� ���Ǵ� ��Ÿ���� @font-face ���� ó���Ǵ� ���̾ ��ε忡 ������ ��ġ�� ����
		//
		// 		����Ʈ�������� ���, ����Ʈ�� ������ ������ SPAN �� ���� �߰��Ǵ� ���� �ƴ� ���õ� SPAN �� fontFamily �� �����Ͽ� ó���ϹǷ�
		// 		fontFamily ���� �� DOM Tree �󿡼� ���̻� ������ �ʴ� ������ ������ �Ǵ��Ͽ� ��ε� �ع���.
		// [�ذ�] 
		//		��ε尡 �߻����� �ʵ��� �޴� ����Ʈ�� ��Ÿ���� ����ϴ� ���� @font-face ���ķ� �ϵ��� ó���Ͽ� DOM Tree �� �׻� ���� �� �ֵ��� ��
		//
		// [SMARTEDITORSUS-969] [IE10] ����Ʈ�� ����Ͽ� ���� ����ϰ�, �������� ���� �� ����Ʈ�� ������ �ʴ� ����
		//		- IE10������ ����Ʈ ��ε尡 �߻����� �ʵ��� ������ ������
		//		     -> ���� : nativeVersion === 9 && documentMode === 9
		//		     -> ���� : nativeVersion >= 9 && documentMode >= 9
...
nhn.husky.SE2M_FontNameWithLayerUI.CUSTOM_FONT_MARKS = "'";	// [SMARTEDITORSUS-169] ����Ʈ�� ��� fontFamily �� ' �� �ٿ��ִ� ó���� ��	
...
function fontProperty(fontId, fontName, defaultSize, fontURL, fontCSSURL){
	...
	if(this.fontCSSURL != ""){
		...
		// addImport �Ŀ� ó�� ���� DOM-Tree �� iframe ������ ��� (setMainFont || addFontInUse ���� ȣ��� ���)
		// �ش� ��Ʈ�� ���� ��ε� ������ ��� �߻��Ͽ� IE9���� addFont ���� ȣ���ϴ� loadCSS �� ��쿡�� isLoaded�� true �� �������� ����.
...
nhn.husky.SE2M_Hyperlink = jindo.$Class({
	...
	$ON_MSG_HYPERLINK_LAYER_SHOWN : function(){
		...
		if(oAnchor && !this.oSelection.collapsed){
			...
			// href�Ӽ��� ������ ���� ���, ��: href="http://na&nbsp;&nbsp; ver.com", IE���� oAnchor.href ���� �ÿ� �˼� ��� ���� �߻��Ŵ
			try{
	...
	$ON_APPLY_HYPERLINK : function(){
		...
		if(this._validateURL(sURL)){
			...
			if(this.oSelection.collapsed){
				...
				// ������ �����ϴ� execcommand�� createLink�δ� Ÿ���� ������ ���� ���.
				// �׷��� ������, ���� URL�� createLink�� �Ѱܼ� ��ũ�� ���� �ɰ�, ���Ŀ� loop�� ���鼭 ���� URL�� ���� A�±׸� ã�Ƽ� ���� URL �� Ÿ���� ���� �� �ش�.
				sBM = this.oSelection.placeStringBookmark();
				this.oSelection.select();
				
				// [SMARTEDITORSUS-61] TD �ȿ� �ִ� �ؽ�Ʈ�� ��ü �����Ͽ� URL �����ϸ� �������� ���� (only IE8)
				//		SE_EditingArea_WYSIWYG ������ IE�� ���, beforedeactivate �̺�Ʈ�� �߻��ϸ� ������ Range�� �����ϰ�, RESTORE_IE_SELECTION �޽����� �߻��ϸ� ����� Range�� ����Ѵ�.
				//		IE8 �Ǵ� IE7 ȣȯ����̰� TD ���� �ؽ�Ʈ ��ü�� ������ ���  Bookmark �� ���� select()�� ó���� ��
				//		HuskyRange ���� ȣ��Ǵ� this._oSelection.empty(); ���� beforedeactivate �� �߻��Ͽ� empty ó���� selection �� ����Ǵ� ������ �־� ��ũ�� ������ ����.
				//		�ùٸ� selection �� ����Ǿ� EXECCOMMAND���� ��ũ�� ���� �� �ֵ��� ��
				if(oAgent.ie && (oAgent.version === 8 || oAgent.nativeVersion === 8)){	// nativeVersion ���� IE7 ȣȯ����� ��� Ȯ��
					this.oApp.exec("IE_FOCUS", []);
					this.oSelection.moveToBookmark(sBM);
					this.oSelection.select();
				}
				
				// createLink ���Ŀ� �̹� ��� A �±׸� ã�� �� �ֵ��� nSession�� �����ϴ� ���� ��ũ�� �����.
	...
	_isExceptional : function(){
		...
		// [SMARTEDITORSUS-612] �̹��� ���� �� ��ũ �߰����� �� ��ũ�� �ɸ��� �ʴ� ����
		...
		// [SMARTEDITORSUS-579] IE8 ���Ͽ��� E-mail ���� ���ڿ��� URL ��ũ ��Ŵ� �̽�
	...
	irToDb : function(oTmpNode){
		//���� ������ �ڵ� ��ũ�� ���� �Լ�.
		//[SMARTEDITORSUS-1207][IE][����] object ���� �� ���� �����ϸ� IE ������ �׾������ ����   
		//���� : Ȯ�� �Ұ�. IE ���۱� ��� �̽��� ����
		//�ذ� : contents�� ������ �ִ� div �±׸� �� �Լ� ���ο��� �����Ͽ� ���� �� call by reference�� �Ѿ�� ������ innerHTML�� ����	
		...
		/*
		// �ؽ�Ʈ �˻��� ���� �ϵ��� ������ �ؽ�Ʈ ��尡 ������ ������. (ȭ������� ABC��� ���̳� ��Ȳ�� ��� ���� 2���� �ؽ�Ʈ A, BC�� �̷���� ���� �� ����. �̸� ABC �ϳ��� ���� ����� ��.)
		// ���� �߻� ���ɼ��� ���ؼ� �����ս��� ���̵� ����Ʈ ���ɼ� ���� �ϴ� �ּ�
		var aCleanTextNodes = [];
		...
		*/
		...
		for(var i=0, nLen=aAllTextNodes.length; i<nLen; i++){
			...
			// www.�Ǵ� http://���� �����ϴ� �ؽ�Ʈ�� ��ũ �ɾ� ��
			// IE���� �ؽ�Ʈ ��� ������ �����̽��� �ּ����� ������� ������ �־� sTmpStr�� �տ� �ٿ���.
			elTmpDiv.innerHTML = "";
...
nhn.husky.SE2M_LineStyler = jindo.$Class({
	...
	//SMARTEDITORSUS-987 SE2M_TOGGLE_LINEHEIGHT_LAYER,SET_LINE_STYLE ���� �ε� ����
	$ON_SE2M_TOGGLE_LINEHEIGHT_LAYER : function(){
		this.oApp.exec("ADD_APP_PROPERTY", ["getLineStyle", jindo.$Fn(this.getLineStyle, this).bind()]);
	},
		...
		if(oSelection.collapsed && !bSelectedBlock){
			...
			if(bNewSpan){
				if(oSelection.startContainer.tagName == "BODY" && oSelection.startOffset === 0){
					...
					if(bAppendable && elTmp.nodeType == 1 && elTmp.tagName == "BR"){// [SMARTEDITORSUS-311] [FF4] Cursor Holder �� BR �� �������� SPAN �� �߰��Ͽ� �߻��ϴ� ����
			...
			// [SMARTEDITORSUS-229] ���� ��Ǵ� SPAN ���� ��Ҽ�/���� ó�� �߰�
			if(!!oStyles.color){
				oSelection._checkTextDecoration(oSpan);
			}
			
			this._addCursorHolder(oSelection, oSpan);	// [SMARTEDITORSUS-178] [IE9] Ŀ���� ���� �ö󰡴� ����
...
*/
		...
		if(bSelectedBlock){
			...
			var bCheckTextDecoration = !!oStyles.color;	// [SMARTEDITORSUS-26] ��Ҽ�/���� ���� ��� ó��
...
//		this.welDropdownLayer.offset(this.htOffsetPos.top-htScrollXY.y, this.htOffsetPos.left-htScrollXY.x);
		...
		// offset width�� IE���� css lazy loading ������ ����� ������ �ʾ� ����� ����
	...
	// [SMARTEDITORSUS-728] ã��/�ٲٱ� ���̾� ���� ��� ��ư active/inactive ó�� �߰�
...
//		var sBookmarkID = oSelection.placeStringBookmark();
		...
		// [SMARTEDITORSUS-430] ���ڸ� �Է��ϰ� Enter �� �ο뱸�� ����� �� ���� ���ڵ��� �ο뱸 �ȿ� ���� ����
		// [SMARTEDITORSUS-1323] ���� ÷�� �� �ο뱸 ��� �� ÷���� ������ �����Ǵ� ����
		// [SMARTEDITORSUS-1567] ����Ű�� �� �� ������ �ʰ� �ο뱸�� �����ϴ� ��쿡 ����
		...
		if(oSelection.startContainer === oSelection.endContainer){
			if(oSelection.startContainer.nodeType === 1 &&
				...
				var _elAncestor = nhn.husky.SE2M_Utils.findAncestorByTagName("P", _elParent); // �� P �±׸� ������ �� �ִ� �θ� ���
				var _aParagraphContainer = ["TD", "BODY"]; // Ž�� ��� TD, BODY ��
		...
		oNode = oStartNode;
		// IE������ commonAncestorContainer ��ü�� select �������� �ʰ�, ������ commonAncestorContainer�� ��ü �ϴ��� �Ȱ��� ������ ����Ʈ �Ǿ� ���̴� 
		// ��尡 ���� ��� ���� ��尡 commonAncestorContainer�� ��ȯ��.
		// �׷���, ��ũ��Ʈ�� commonAncestorContainer ��� �ϵ��� ��.
		// ��)
		// <P><SPAN>TEST</SPAN></p>�� ���� �� ���, <SPAN>TEST</SPAN>�� commonAncestorContainer�� ����
		oSelection.fixCommonAncestorContainer();
		...
		if(nhn.husky.SE2M_Utils.isBlankNode(oFormattingNode)){
			...
			// [SMARTEDITORSUS-645] ���� ��Ŀ�� ���� �ο뱸 �߰����� �� IE7���� �ڽ��� �þ�� ����
			
			// [SMARTEDITORSUS-1567] [Chrome] �ο뱸 ���� ���� ������ �ƹ��͵� ��� ��쿡 ����
			//oFormattingNode.innerHTML = "&nbsp;";
			var htBrowser = jindo.$Agent().navigator();
			if(htBrowser.chrome){ // P �±׷� �������� ������ blockquote �±׿� ������ ���Ǵµ�, DB�� �Ѿ �� ��Ÿ���� ������ �ʴ� ���� �߰�
		...
		setTimeout(jindo.$Fn(function(oSelection){
			...
			this.oApp.exec("FOCUS");	// [SMARTEDITORSUS-469] [SMARTEDITORSUS-434] ������ �ε� �� ���� ������ �ο뱸 �ȿ� ��Ŀ���� ���� �ʴ� ����
	...
	// [SMARTEDITORSUS-209] �ο뱸 ���� ������ ���� �� Backspace �� �ο뱸�� �����ǵ��� ó��
	...
	// [SMARTEDITORSUS-215] Delete �� �ο뱸 ���� P �� ���ŵ��� �ʵ��� ó��
...
nhn.husky.SE2M_TableBlockStyler = jindo.$Class({
	...
	setTdBlock : function() {
		this.oApp.exec("GET_SELECTED_CELLS",['aTdCells',this.htSelectedTD]); //tableEditor�� ���� ���´�.
...
nhn.husky.SE2M_TableCreator = jindo.$Class({
	...
	// [SMARTEDITORSUS-365] ���̺������ > �Ӽ� �����Է� > �׵θ� ��Ÿ��
	//		- �׵θ� ������ �����ϴ� ��� ������ �����ϴ� ǥ�� ���̵� ������ ǥ���� �ݴϴ�. ���� �ÿ��� �׵θ��� ������ �ʽ��ϴ�.
	$ON_REGISTER_CONVERTERS : function(){
	...
	irToDbDOM : function(oTmpNode){
		...
		// �׵θ��� ���� �Ӽ��� table (���Ƿ� �߰��� attr_no_border_tbl �Ӽ��� �ִ� table �� ã��)
	...
	dbToIrDOM : function(oTmpNode){
		...
		for(var i = 0, nCount = aNoBorderTable.length; i < nCount; i++){
			...
			// <TABLE> ���� border, cellpadding �Ӽ��� ����/ style �Ӽ� �߰�
...
//		this.oSelection = this.oApp.getSelection();
	...
	$ON_TABLE_INSERT : function(){
		this.oApp.exec("IE_FOCUS", []);	// [SMARTEDITORSUS-500] IE�� ��� ������� focus �߰�
		
		//[SMARTEDITORSUS-596]�̺�Ʈ �߻��� �ȵǴ� ���, 
		//max ������ ����� �ȵǱ� ������ ���̺� ���� ������ �ٽ��ѹ� Max ���� �˻��Ѵ�.
		...
		if(htBrowser.ie && this.oApp.getWYSIWYGDocument().body.childNodes.length === 1 && this.oApp.getWYSIWYGDocument().body.firstChild === elTableHolder){
			// IE���� table�� body�� �ٷ� �پ� ���� ���, ���ĵ�� ������ �߻� ������ elTableHolder(DIV)�� ���ܵ�
		...
		// FF : ���̺� �ϴܿ� BR�� ���� ���, Ŀ���� ���̺� ������ �̵��� �� ��� BR�� ���� �� ��.
		//[SMARTEDITORSUS-181][IE9] ǥ�� ���� ���� ���̺?�� > ���̺� �ܺη� Ŀ�� �̵� �Ұ�
	...
	_divideParagraph : function(oSelection){
		...
		oSelection.fixCommonAncestorContainer();	// [SMARTEDITORSUS-423] ���Ϳ� ���� ��� P �� �ƴ� ���� P �� ���õ��� �ʵ��� fix �ϵ��� ó��
		...
		if(!oParentP.firstChild || nhn.husky.SE2M_Utils.isBlankNode(oParentP)){
			oSelection.selectNode(oParentP);	// [SMARTEDITORSUS-423] ���ʿ��� ������ �Ͼ�� �ʵ��� �� P �� �����Ͽ� TABLE �� ��ü�ϵ��� ó��
			oSelection.select();
	...
	_doGetTableString : function(nColumns, nRows, nBorderSize, sBorderColor, sBGColor, nBorderStyleIdx){
		...
		// [SMARTEDITORSUS-365] ���̺������ > �Ӽ� �����Է� > �׵θ� ��Ÿ��
		//		- �׵θ� ������ �����ϴ� ��� ������ �����ϴ� ǥ�� ���̵� ������ ǥ���� �ݴϴ�. ���� �ÿ��� �׵θ��� ������ �ʽ��ϴ�.
		//		- �� ���� �ÿ��� �� �ۼ� �ÿ� ����Ͽ��� style �� �����մϴ�. �̸� ���ؼ� ������ �Ӽ�(attr_no_border_tbl)�� �߰��Ͽ��ٰ� ���� �������� ������ �ֵ��� �մϴ�.
...
//			var rxSelectionColor = new RegExp("<(TH|TD)[^>]*)("+this.TMP_BGC_ATTR+"=[^> ]*)([^>]*>)", "gi");
	...
	_assignHTMLObjects : function(){
		...
		//		this.elPanelReviewBtnArea = jindo.$$.getSingle("DIV.se2_btn_area", this.elQELayer); 	//My���� ��ư ���̾�
...
//		this.oApp.registerBrowserEvent(this.elPanelReviewBtnArea, "click", "SAVE_QE_MY_REVIEW_ITEM"); //My���� ��ư ���̾�
	...
	// [Undo/Redo] Table Selection ó���� ��õ� �κ� �ּ� ó��
	...
	$ON_TABLE_QE_SET_IMG : function(elSelected){
		...
		if(n === "0"){
			...
			if(n == 19 || n == 20 || n == 21 || n == 22 || n == 25 || n == 26){ //���� ��������� jpg
	...
	$ON_SETUP_TABLE_QE_MODE : function(nMode){
		...
		for(var i = 1, nLen = this.aSelectedCells.length; i < nLen; i++){
			// [SMARTEDITORSUS-1552] �巡�׷� ���� �����ϴ� �� elCell�� ��� ��� ���� �߻�
...
//			this.elSelectBoxTemplate.style.position = "";
			...
			//this.elPanelReviewBtnArea.style.display = "none"; //My���� ��ư ���̾�
...
//			this.elSelectBoxTemplate.style.position = "static";
			...
			//	this.elPanelReviewBtnArea.style.display = "block"; //My���� ��ư ���̾�
...
//top.document.title = this.htSelectionSPos.x+","+this.htSelectionSPos.y+"::"+this.htSelectionEPos.x+","+this.htSelectionEPos.y;
	...
	_coverResizeLayer : function(){
		// [SMARTEDITORSUS-1504] ������ ��ü ũ�⺸�� â�� �۾����� �� elResizeGrid�� �ִ�ȭ�� elResizeCover���κ��� ����� �̽��� ����
	...
	_reassignCellSizes : function(elTable){
		...
		for(var n = 0; n < 2; n++){
			for(var i = 0; i < allCells[n].length; i++){
				...
				// [SMARTEDITORSUS-1427][SMARTEDITORSUS-1431][SMARTEDITORSUS-1491][SMARTEDITORSUS-1504] IE9, 10���� Jindo.$Element#css �� �� �Ӽ����� 1px�� �������� �������� �־� ��ü
				...
				// [SMARTEDITORSUS-1504] ���� ���� ����� inherit�� ��Ÿ���� �������� ���ϴ� ������ �Բ�, �Ϻ� �������� �Ҽ��� ���� �����ϴ� ������ �ִ�.
				var isIEUnder9 = false;

				// �Ź� �߻��ϴ� ������¡ ������ �ּ��ϱ� ���Ͽ�, 2ȸ�����ʹ� 1ȸ���� ���Ǵ� style ���� �����´�.
				...
				// [SMARTEDITORSUS-1571] IE 10 �̻��ӿ��� �ұ��ϰ�, ���� ��尡 8 ���Ϸ� �����Ǿ� �ִ� ��찡 �־� �޼��� ��� �б�� ����
				//if(!isIEUnder9){
				if(elCell.getComputedStyle){
				// --[SMARTEDITORSUS-1571]
					// getComputedStyle()�� inherit�� ��Ÿ���� ȹ��. IE 8 ���Ͽ����� ������� �ʴ´�.  
					...
					// ���� ������¡ ���� width attribute���� style�� width�� �����ϴ� �������� �̼������� �ֱ� ������ ũ�Ⱑ ���� ���Ѵ�.
				...
				if(bResizingGapShouldBeMinimized){
					...
					var nHeight = jindo.$Element(elCell).attr("height");
					 ...
					 // width�� height attribute�� ���� 1ȸ�� ���ŵȴ�. �� 2ȸ������ �ش��ϸ�, �������� ���ϴ� style�� width, height ���� �״�� ����� �� �ִ�.
					if(!nWidth && !nHeight){
				...
				/*if(htBrowser.ie && (htBrowser.nativeVersion >= 9 && htBrowser.nativeVersion <= 10)){
					// IE9, IE10
					// [SMARTEDITORSUS-1427][SMARTEDITORSUS-1431][SMARTEDITORSUS-1491] IE9, 10���� Jindo.$Element#css ��� ������ �����ϸ� �ٸ� ������� ������ ���� ��� ����
...
//			jindo.$Element(aCellInfo[0]).css("height", aCellInfo[2]);
	...
	_mousedown_ResizeCover : function(oEvent){
		...
		// [SMARTEDITORSUS-1504] ǥ �׵θ��� ���� ������ �۾���� 2px�� ���η� ������� ������ �ִµ�, �̸� ���� flag
		...
		// [SMARTEDITORSUS-1504] ǥ ��������� gripper�� ��ġ�� WYSIWYG ���� ���� ��ġ ������� ���� 
	...
	_mousemove_ResizeCover : function(oEvent){
		// [SMARTEDITORSUS-1504] ǥ �𼭸� Drag ��뼺 ����
		// - ���� ������¡ �� �ش� ��ġ���� �ٷ� ���콺�� ���� Drag ����
	...
	_mouseup_ResizeCover : function(oEvent){
		...
		// [SMARTEDITORSUS-1504] FireFox�� �Ҽ������� size�� �����µ�, parseInt�� �Ҽ��� ���ϸ� ����
		var htBrowser = jindo.$Agent().navigator();
		var isIEUnder9 = false;
	...
	_isOnBorder : function(wevE){
		...
		if(this.htResizing.htEPos.offsetY <= nAdjustedDraggableCellEdge1){
			...
			if(this.htResizing.elCell.parentNode.previousSibling){
				...
				// [SMARTEDITORSUS-1504] ǥ ��������� gripper ��ġ ����
		...
		if(this.htResizing.htEPos.offsetX <= nAdjustedDraggableCellEdge1){
			...
			// [SMARTEDITORSUS-1504] ǥ ��������� gripper ��ġ ����
			// �Ϲ� ǥ�� �Ʒ� if���� ��ġ�� ������, �۾���� ��� ���� ���� cell�� previousSibling�� textNode�̱� ������ if���� �����ϴ� ������ �־��.
			...
			// ���� ������ cell�� �� offsetLeft�� table�� scrollLeft�� ����.
	...
	_showCellResizeGrip : function(){
		// [SMARTEDITORSUS-1504] gripper�� WYSIWYG ���� ��ġ������ ����Ͽ� ��ġ�ǵ��� ����
		/*if(this.htResizing.nResizeMode == 1){
		...
		}else if(this.htResizing.nResizeMode == 2){ // �Ʒ��� ���
			//�������� �����ϱ� ������ �Ź� ���� Container�� ũ�⸦ ���ؿͼ� Grip�� ���ؾ� �Ѵ�.
			var elIFrameWidth = this.oApp.elEditingAreaContainer.offsetWidth + "px";
			this._setResizerSize(this.parseIntOr0(elIFrameWidth), (this.htResizing.nBorderSize + this.nDraggableCellEdge) * 2);
	...
	_createCellResizeGrip : function(){
		...
		// [SMARTEDITORSUS-1504] gripper�� WYSIWYG ���� ���� ��ġ ������ ����Ͽ� ��ġ�ϵ��� ����
		//document.body.appendChild(this.elResizeGrid);
		// document.body ��� WYSIWYG ���� ������ �ѷ��� container div�� �߰�
	...
	_insertColumnAfter : function(){
		...
		// [SMARTEDITORSUS-991] IE�� insertionPt�� previousSibling���� ������ �������� �� �ʿ䰡 ����.
		var htBrowser = jindo.$Agent().navigator();
		// --[SMARTEDITORSUS-991]
		...
		for(var y = 0, nYLen = this.htMap[0].length; y < nYLen; y++){
			...
			for(var x = this.htSelectionEPos.x; x >= this.htSelectionSPos.x; x--){
				...
				// elCellClone�� outerHTML�� �������� rowSpan�� �ִ��� IE������ �� ��ġ���� �׻� 1�� ��ȯ. (elCellClone.rowSpan & elCellClone.getAttribute("rowSpan")).
				...
				// [SMARTEDITORSUS-991] IE�� insertionPt�� previousSibling���� style�� �������� �� �ʿ䰡 ����.
				// IE�� ��� DOM ���� �� �� �ؽ�Ʈ ��带 �ϳ� �߰��� ��� �Ѵ�.
	...
	_insertRowBelow : function(){
		...
		for(var y = this.htSelectionSPos.y; y <= this.htSelectionEPos.y; y++){
			...
			// [SMARTEDITORSUS-991] IE�� DOM ���� �� �� �ؽ�Ʈ ��带 �� ��� ���̿� ���Խ��� ��� �Ѵ�. 
			if(htBrowser.ie && htBrowser.nativeVersion >= 9){
				// elRowClone�� td ���̻��̿� �� �ؽ�Ʈ ��带 ���Խ�Ų ���ο� tr�� ��
				var elAdjustedRowClone = document.createElement("tr");
				
				var aRowClone = elRowClone.childNodes;
				
				// ¦�� �ε������� ���� elRowClone��, Ȧ�� �ε������� �� �ؽ�Ʈ ��带 ����
			...
			// [SMARTEDITORSUS-991] IE�� insertionPt�� previousSibling���� �߰��� ������ �������� �� �ʿ䰡 ����.
			if(htBrowser.ie && htBrowser.nativeVersion >= 9){
				// IE�� ��� tr ���̿��� �� �ؽ�Ʈ ��带 �ϳ� �߰��� ��� �Ѵ�.
				var elEmptyTextNode = aTRs[this.htSelectionEPos.y].nextSibling.cloneNode();
...
*/
	...
	_addClassToSelection : function(){
		...
		for(var i = 0; i < this.aSelectedCells.length; i++){
			...
			// [SMARTEDITORSUS-1552] �巡�׷� ���� �����ϴ� �� elCell�� ��� ��� ���� �߻�
			if(elCell){
				// [SMARTEDITORSUS-1498][SMARTEDITORSUS-1549] ���õ� ��� ������ �巡�װ� �߻����� ���ϰ� ����(FF, Chrome)
...
nhn.husky.SE2M_QuickEditor_Common = jindo.$Class({
	...
	getData : function() {
		...
		jindo.$Ajax(self._sBaseAjaxUrl, {
			...
			onload: function(rp) {
				...
				// [SMARTEDITORSUS-1028][SMARTEDITORSUS-1517] QuickEditor ���� API ����
	...
	setOpenType : function(sType,bBol){
		// [SMARTEDITORSUS-1213] �ۼ��� ������ ���� ȭ�鿡�� ������ �ε���ڸ��� �ٷ� ������ Ŭ���ϸ� QuickEditor�� ���� �� ������ ���� 
	...
	$LOCAL_BEFORE_FIRST : function(sMsg) {
		...
		new jindo.DragArea(this._qe_wrap, {
			...
			dragEnd : function(oCustomEvent){
				...
				//if(that._currentType=="review"||that._currentType=="table"){	// [SMARTEDITORSUS-153] �̹��� �� �����͵� ���� �������� ó���ϵ��� ����
...
//		var beforeY = oBefore.css("top");
		...
		// [SMARTEDITORSUS-1028][SMARTEDITORSUS-1517] QuickEditor ���� API ��������, submit ���� �߻��ϰ� �Ǵ� beforeunload �̺�Ʈ ��� ȣ�� ���� ����
		// QuickEditor�� ���� ��ĥ ������ API ����� ��ġ�� ������ submit�̳� beforeunload�� ���ֹ��� �ʰ� �������� ������ ���� ����
		if (!this._environmentData || !this._bUseConfig) {
			return;
		}
...
*/
	...
	/**
	 * ���̾ ���µ� ���̾ table(���ø�),img������ Ȯ���Ͽ� id�� ��ȯ�ϴ� �Լ�.
	 * @param {Element} oEle
	...
	get_position_layer : function(oEle , oLayer){
		...
		//if(this._currentType == "review" || this._currentType == "table"){	// [SMARTEDITORSUS-153] �̹��� �� �����͵� ���� �������� ó���ϵ��� ����
 ...
 * ��Ƽ�� ���̾ ȭ�鿡 ���̴� ���θ� ��� �Ѵ�.
 *
 * oLayer HTMLElement ���̾�� ����� HTML Element
 * sOnOpenCmd string ȭ�鿡 ���̴� ��� �߻� �� �޽���(�ɼ�)
 * aOnOpenParam array sOnOpenCmd�� �Բ� �Ѱ��� �Ķ����(�ɼ�)
 * sOnCloseCmd string �ش� ���̾ ȭ�鿡�� ����� �� �߻� �� �޽���(�ɼ�)
 * aOnCloseParam array sOnCloseCmd�� �Բ� �Ѱ��� �Ķ����(�ɼ�)
 *
---------------------------------------------------------------------------]*/
/*[
 * SHOW_ACTIVE_LAYER
 ...
 * ���̾�α� ���̾ ȭ�鿡 �����ش�.
 *
 * oLayer HTMLElement ���̾�α� ���̾�� ��� �� HTML ������Ʈ
 *
---------------------------------------------------------------------------]*/
/*[
 * HIDE_DIALOG_LAYER
 ...
 * ���̾�α� ���̾ ȭ�鿡 ����.
 *
 * oLayer HTMLElement ��� ���̾�α� ���̾ �ش� �ϴ� HTML ������Ʈ
 *
---------------------------------------------------------------------------]*/
/*[
...
/**
 * @description �˾� �Ŵ��� �ν��Ͻ� ȣ�� �޼ҵ�, nhn.husky js framework ��� �ڵ�
 * @public
 * @param {Object} oApp �㽺Ű �ھ� ��ü�� �Ѱ��ش�.(this.oApp)
 * @return {Object} nhn.husky.PopUpManager Instance
 * @example �˾���� �÷����� ���� ����
 * nhn.husky.NewPlugin = function(){
 * 	this.$ON_APP_READY = function(){
 * 		// �˾� �Ŵ��� getInstance �޼ҵ带 ȣ���Ѵ�.
 * 		// �㽺Ű �ھ��� �������� �Ѱ��ش�(this.oApp)
 ...
 * 		var oWinOp = {
 * 			oApp : this.oApp,	// oApp this.oApp �㽺Ű ������
 * 			sUrl : "", // sUrl : ������ URL
 * 			sName : "", // sName : ������ name
 * 			nWidth : 400,
 * 			nHeight : 400,
	...
	if (this._instance==null) {
		...
		this._instance = new (function(){
			...
			this.openWindow = function(oWinOpt) {
				...
				if(op.oApp == null) {
					alert("�˾� ��û�� �ɼ����� oApp(�㽺Ű reference) ���� �����ϼž� �մϴ�.");
				}
...
/**
* @description opener ���� interface
 * @public
 * @param {Object} oOpenWin �˾� �������� window ��ü
 * @param {Object} sMsg	�÷����� �޽�����
 * @param {Object} oData	���� ����Ÿ
 */
...
nhn.husky.SE2M_ImgSizeRatioKeeper = jindo.$Class({
	...
	_onResizeEnd : function(wev){
		...
		// [SMARTEDITORSUS-299] ���콺 Drag�� �̹��� ũ�� �������� ��, ������ ���� ���� ������(rwidth/rheight)�� ������ ��
		...
		// �Ʒ��� �κ��� ���� hp_SE2M_ImgSizeAdjustUtil.js �� ���Ͽ� �и��Ѵ�.
...
nhn.husky.SE2M_Utils = {
	 ...
	 * @param {rx} rxValue	rx type ����� ��
	 * @param {String} sDivision	value�� split ���
	 * @return {Array}
	 */
	...
	/**
	 * HashTable�� ������ Array�� ���� ������Ƽ�� sSeperator �� ���е� String ������ ��ȯ
	 * @param {Object} v
	 * @param {Object} sKey
	 * @author senxation
	 * @example 
...
makeArray("test"); ==> ["test"]
	...
	/**
	 * �������� �Ҷ� ���� ����� �����̳ʰ� �ٸ� ��� ó��
	 * �����̳��� css white-space���� "normal"�̾���Ѵ�. (�����̳ʺ��� �ؽ�Ʈ�� ��� ���������� ǥ���Ǵ� ����)
	 * @param {HTMLElement} elText �������� ������Ʈ
	 * @param {HTMLElement} elContainer �������� ������Ʈ�� ���δ� �����̳�
	 * @param {String} sStringTail �������� ǥ���� ���ڿ� (�������� ...)
	 * @param {Number} nLine �ִ� ���μ� (�������� 1)
	 * @author senxation
	 * @example
//div�� 2�� ���ϰ� �ǵ��� strong ������ ������ ���� 
<div>
	<strong id="a">������������ҳ��븻����������ҳ��븻����������ҳ���</strong><span>�󼼺���</span>
<div>
ellipsis(jindo.$("a"), jindo.$("a").parentNode, "...", 2);
	...
	/**
	 * �ִ� ���λ���� �����Ͽ� �������Ѵ�.
	 * elText�� css white-space���� "nowrap"�̾���Ѵ�. (�����̳ʺ��� �ؽ�Ʈ�� ��� �ຯȯ�����ʰ� ���η� ��� ǥ���Ǵ� ����)
	 * @param {HTMLElement} elText �������� ������Ʈ
	 * @param {String} sStringTail �������� ǥ���� ���ڿ� (�������� ...)
	 * @param {Function} fCondition ���� �Լ�. ���ο��� true�� �����ϴ� ���ȿ��� �������� �����Ѵ�.
	 * @author senxation
	 * @example
//150�ȼ� ���ϰ� �ǵ��� strong ������ ������ ���� 
<strong id="a">������������ҳ��븻����������ҳ��븻����������ҳ���</strong>>
ellipsisByPixel(jindo.$("a"), "...", 150);
	...
	/**
	 * �������� ������Ʈ�� ������ ������ �ִ�ʺ�� �������Ѵ�.
	 * �������� ������Ʈ�� css white-space���� "nowrap"�̾���Ѵ�. (�����̳ʺ��� �ؽ�Ʈ�� ��� �ຯȯ�����ʰ� ���η� ��� ǥ���Ǵ� ����)
	 * @param {Array} aElement �������� ������Ʈ�� �迭. ������ ���� �������Ѵ�.
	 * @param {String} sStringTail �������� ǥ���� ���ڿ� (�������� ...)
	 * @param {Array} aMinWidth �������� �ʺ��� �迭.
	 * @param {Function} fCondition ���� �Լ�. ���ο��� true�� �����ϴ� ���ȿ��� �������� �����Ѵ�.
	 * @example
//#a #b #c�� �ʺ� ���� 100, 50, 50�ȼ��� ���� (div#parent �� 200�ȼ� �����̸� �ߴ�)
//#c�� �ʺ� ���̴� ���� fCondition���� false�� �����ϸ� b, a�� ������ ���� �ʴ´�.  
<div id="parent">
	<strong id="a">������������ҳ���</strong>
	<strong id="b">������������ҳ���</strong>
	<strong id="c">������������ҳ���</strong>
<div>
...
==> { a : 1, c : 3 }
	...
	/**
	 * elNode�� ���� ��� �� �±׸��� sTagName�� ��ġ�ϴ� ���� �ִٸ� ��ȯ.
	 * @param {String} sTagName �˻� �� �±׸�
	 * @param {HTMLElement} elNode �˻� ���������� ��� �� ���
	 * @return {HTMLElement} �θ� ��� �� �±׸��� sTagName�� ��ġ�ϴ� ���. ���� ��� null ��ȯ 
	 */
		...
		if(fnCallback){
			if ('onload' in elStyle) {
				...
				elStyle.onreadystatechange = function(){
					...
					// [SMARTEDITORSUS-308] [IE9] ������ 304�� ���
					//	onreadystatechage �ڵ鷯���� readyState �� complete �� ��찡 �� �� �߻�
					//	LINK ������Ʈ�� �Ӽ����� �ݹ� ���� ���θ� �÷��׷� ���ܳ��� ó����
	...
	/**
	 * jindo.$JSON.fromXML�� ��ȯ�� �޼���.
	 * �Ҽ����� �ִ� ����� ó�� �ÿ� ���ڷ� ��ȯ���� �ʵ��� ��(parseFloat ��� ���ϵ��� ����)
	 * ��� BTS : [COM-1093]
	...
	getJsonDatafromXML : function(sXML) {
		...
		var cb = function($0,$1,$2,$3,$4,$5) {
			...
			if (typeof $1 == "string" && $1) {
				...
				cdata = $4;
			} else if (typeof $5 == "string" && $5.replace(re3, "")) { // [SMARTEDITORSUS-1525] �ݴ� �±��ε� ��鹮�ڰ� ����־� cdata ���� ����� ��� ���� 
				cdata = es($5);
			}
...
nhn.husky.AutoResizer = jindo.$Class({
	...
	$init : function(el, htOption){
		...
		this.welTextArea = jindo.$Element(el);	// autoresize�� ����� TextArea
...
nhn.husky.StringConverterManager = jindo.$Class({
	...
	applyConverter : function(sRuleName, sContents, oDocument){
		//string�� �ִ� ����:IE�� ���,���� �տ� �ִ� html �ּ��� �����Ǵ� ��찡 �ֱ⶧���� �ӽ� string�� �߰����ذ���.
		var sTmpStr =  "@"+(new Date()).getTime()+"@";
		var rxTmpStr = new RegExp(sTmpStr, "g");
...
//		this.oApp.exec("MSG_STRING_CONVERTER_STARTED_"+sRuleName, [oRes]);
		...
		if(aConverters){
			...
			//IE�� ���, sContents�� innerHTML�� �ִ� ��� string�� <p>tag ���̿� '\n\'���๮�ڸ� �־��ش�. 
			if( jindo.$Agent().navigator().ie ){
				sTmpStr = sTmpStr +'(\r\n)?'; //ie+win������ ������ \r\n�� ��.
 ...
 * ATTACH_HOVER_EVENTS
 *
 * �־��� HTML������Ʈ�� Hover �̺�Ʈ �߻�� Ư�� Ŭ������ �Ҵ� �ǵ��� ����
 *
 * aElms array Hover �̺�Ʈ�� �� HTML Element ���
 * sHoverClass string Hover �ÿ� �Ҵ� �� Ŭ����
 *
---------------------------------------------------------------------------]*/
/**
 * @pluginDesc Husky Framework���� ���� ���Ǵ� ��ƿ�� �޽����� ó���ϴ� �÷�����
 */
...
nhn.husky.SE2B_Customize_ToolBar = jindo.$Class(/** @lends nhn.husky.SE2B_Customize_ToolBar */{
	...
	/**
	 * @constructs
	 * @param {Object} oAppContainer �����͸� �����ϴ� �����̳�
	 */
	$init : function(oAppContainer) {
		this._assignHTMLElements(oAppContainer);
	},
	...
	/**
	 * @private
	 * @description DOM������Ʈ�� �����ϴ� �޼ҵ�
	 * @param {Object} oAppContainer ��� ���� �����͸� ���ΰ� �ִ� div ������Ʈ
	 */
	_assignHTMLElements : function(oAppContainer) {
	...
	/**
	 * CHANGE_EDITING_MODE��� ���Ŀ� ȣ��Ǿ�� ��. 
	 * WYSIWYG ��尡 Ȱ��ȭ�Ǳ� �� ȣ���� �Ǹ� APPLY_FONTCOLOR���� ���� �߻�.
	 */
 ...
 */
var oMessageMap = {
	'SE_EditingAreaManager.onExit' : '������ ����Ǿ���ϴ�.',
	'SE_Color.invalidColorCode' : '���� �ڵ带 �ùٸ��� �Է��� �ּ���. \n\n ��) #000000, #FF0000, #FFFFFF, #ffffff, ffffff',
	'SE_Hyperlink.invalidURL' : '�Է��Ͻ� URL�� �ùٸ��� �ʽ��ϴ�.',
	'SE_FindReplace.keywordMissing' : 'ã���� �ܾ �Է��� �ּ���.',
	'SE_FindReplace.keywordNotFound' : 'ã���� �ܾ ����ϴ�.',
	'SE_FindReplace.replaceAllResultP1' : '��ġ�ϴ� ������ �� ',
	'SE_FindReplace.replaceAllResultP2' : '�� �ٲ����ϴ�.',
	'SE_FindReplace.notSupportedBrowser' : '���� ����ϰ� ��� �������� ����ϽǼ� ��� ����Դϴ�.\n\n�̿뿡 ������ ��� �˼��մϴ�.',
	'SE_FindReplace.replaceKeywordNotFound' : '�ٲ� �ܾ ����ϴ�',
	'SE_LineHeight.invalidLineHeight' : '�߸�� ���Դϴ�.',
	'SE_Footnote.defaultText' : '���ֳ����� �Է��� �ּ���',
	'SE.failedToLoadFlash' : '�÷��ð� ���ܵǾ� �־� �ش� ����� ����� �� ����ϴ�.',
	'SE2M_EditingModeChanger.confirmTextMode' : '�ؽ�Ʈ ���� ��ȯ�ϸ� �ۼ��� ������ �����ǳ�, \n\n�۲� ���� ����ȿ��� �̹��� ���� ÷�γ����� ��� ������� �˴ϴ�.\n\n��ȯ�Ͻðڽ��ϱ�?',
	'SE2M_FontNameWithLayerUI.sSampleText' : '�����ٶ�'
};
